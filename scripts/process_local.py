...
def process(path):
    ...
    if teacher_col and teacher_col in df.columns:
        ...
        topath = plot_overall_pos_neg(
            t_positive, t_negative, "Teacher overall Positive vs Negative", tover
        )
    ...
    if facility_col and facility_col in df.columns:
        ...
        fopath = plot_overall_pos_neg(
            f_positive, f_negative, "Facility overall Positive vs Negative", fover
        )
...
if __name__ == "__main__":
    ...
    if not candidate:
        candidate = Path(
            os.path.join(
                os.path.dirname(__file__), "..", "data", "student_feedback.csv"
            )
        )
